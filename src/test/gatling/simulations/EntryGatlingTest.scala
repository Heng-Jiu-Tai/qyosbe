...
class EntryGatlingTest extends Simulation {
    ...
    val headers_http = Map(
        ...
        val authorization_header = "Basic " + Base64.getEncoder.encodeToString("qyosbeapp:mySecretOAuthSecret".getBytes(StandardCharsets.UTF_8))
